...
public class XlUtils {
	// Method to read data from Excel file
		...
		public static void main(String[] args) throws IOException {
			//System.out.println(readDataFromXl("C:\\Users\\chait\\OneDrive\\jan182024.xlsx","Sheet1",2,0));
			List<List<String>> allData = readAllDataFromXl("C:\\Users\\chait\\OneDrive\\studentRegistrationData.xlsx","Sheet1");
